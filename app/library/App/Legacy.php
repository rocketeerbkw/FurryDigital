...
class Legacy
{
    ...
    /**
     * @var array App-specific site settings loaded from global configuration.
     */
    ...
    /**
     * Initialize the App legacy class.
     * @return bool
     */
    ...
    public function canSeeArt($art_type, $include_cookie = true)
    {
        ...
        // Check for the X-App-Force-Worksafe header.
        if (isset($_SERVER['X-App-Force-Worksafe']) && $_SERVER['X-App-Force-Worksafe'] == true)
            return false;
