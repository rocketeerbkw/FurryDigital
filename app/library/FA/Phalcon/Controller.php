...
class Controller extends \Phalcon\Mvc\Controller
{
    ...
    {
        if (FA_APPLICATION_ENV == 'production' && !FA_IS_SECURE)
        {
            $this->doNotRender();
    ...
    public function flash($message, $level = \FA\Flash::INFO)
    {
    ...
    protected function renderForm(\FA\Form $form, $mode = 'edit', $form_title = NULL)
    {
        $this->view->hide_title = false;
        $this->view->setViewsDir(FA_INCLUDE_BASE.'/modules/frontend/views/scripts/');
