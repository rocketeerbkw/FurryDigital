...
class Session
{
    ...
    public function getNamespace($namespace = 'default')
    {
        ...
        {
            if (self::isActive())
                $this->_sessions[$session_name] = new \FA\Session\Instance($this, $session_name);
            else
                $this->_sessions[$session_name] = new \FA\Session\Temporary($this, $session_name);
        }
    ...
    {
        $app_hash = strtoupper(substr(md5(FA_INCLUDE_BASE), 0, 5));
