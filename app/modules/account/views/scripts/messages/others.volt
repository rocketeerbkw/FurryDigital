...
<form method="post" action="{{ url.routeFromHere(['type': notify_key]) }}">
    <input type="hidden" name="csrf" value="{{ csrf.generate('messages') }}">
    <div class="panel panel-default" id="{{ notify_key }}">
        <div class="panel-heading">
            <div class="floatright">
                <button class="btn btn-sm btn-danger" type="submit" name="do" value="remove_all">Mark All as Read</button>
            </div>
